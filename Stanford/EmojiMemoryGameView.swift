...
struct EmojiMemoryGameView: View {
    ...
    var deckBody: some View {
        ...
        .frame(width: CardConstant.undealWidth, height: CardConstant.undealHeigth)
        .foregroundColor(CardConstant.color)
        .onTapGesture {
            // "deal" cards
    ...
    private struct CardConstant {
        ...
        static let undealHeigth: CGFloat = 90
        static let undealWidth = undealHeigth * aspectRatio
